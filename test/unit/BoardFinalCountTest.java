...
public class BoardFinalCountTest extends CardTest {
    ...
    @Test
    void testExampleBoardFinalCountFor1Player(){
        ...
        List<Player> endPlayer = gameTable.endGame();
        ...
        assertEquals(75,endPlayer.get(0).getSumOfPoints());

    }

    @Test
    void simulateExample4PlayerGame(){
        //player1
        ...
        List<Player> calculatedPlayers = gameTable.endGame();

        assertEquals(12,calculatedPlayers.get(0).getEcosystemGapPoints());
        assertEquals(0,calculatedPlayers.get(0).getNumberOfGaps());
        assertEquals(3,calculatedPlayers.get(0).getBoard().getWolfCount());
        assertEquals(12,calculatedPlayers.get(0).getGeneralPointCount().get(Card.CardType.WOLF));
        assertEquals(5,calculatedPlayers.get(0).getGeneralPointCount().get(Card.CardType.RIVER));
        assertEquals(72,calculatedPlayers.get(0).getSumOfPoints());

        assertEquals(7,calculatedPlayers.get(1).getEcosystemGapPoints());
        assertEquals(3,calculatedPlayers.get(1).getNumberOfGaps());
        assertEquals(0,calculatedPlayers.get(1).getBoard().getWolfCount());
        assertEquals(0,calculatedPlayers.get(1).getGeneralPointCount().get(Card.CardType.WOLF));
        assertEquals(8,calculatedPlayers.get(1).getGeneralPointCount().get(Card.CardType.RIVER));
        assertEquals(63,calculatedPlayers.get(1).getSumOfPoints());

        assertEquals(12,calculatedPlayers.get(2).getEcosystemGapPoints());
        assertEquals(2,calculatedPlayers.get(2).getNumberOfGaps());
        assertEquals(3,calculatedPlayers.get(2).getBoard().getWolfCount());
        assertEquals(12,calculatedPlayers.get(2).getGeneralPointCount().get(Card.CardType.WOLF));
        assertEquals(0,calculatedPlayers.get(2).getGeneralPointCount().get(Card.CardType.RIVER));
        assertEquals(74,calculatedPlayers.get(2).getSumOfPoints());

        assertEquals(12,calculatedPlayers.get(3).getEcosystemGapPoints());
        assertEquals(1,calculatedPlayers.get(3).getNumberOfGaps());
        assertEquals(3,calculatedPlayers.get(3).getBoard().getWolfCount());
        assertEquals(12,calculatedPlayers.get(3).getGeneralPointCount().get(Card.CardType.WOLF));
        assertEquals(0,calculatedPlayers.get(3).getGeneralPointCount().get(Card.CardType.RIVER));
        assertEquals(65,calculatedPlayers.get(3).getSumOfPoints());

    }

    private Player playerFabricMethod(String name, ArrayList<ArrayList<Card>> cardBoard){
        var board = new Board();
